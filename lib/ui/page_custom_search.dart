...
class CustomSearchState extends State<CustomSearchPage> {
  ...
  Padding buildPropertyChip(index, chipName, chipImage, chipColor) {
    return Padding(
      padding: (index == 0)
          ? EdgeInsets.only(left: size!.getWidthPx(10))
          : EdgeInsets.only(left: size!.getWidthPx(25)),
      child: Transform(
        transform: new Matrix4.identity()..scale(1.13),
        child: InputChip(
          shape: RoundedRectangleBorder(
              borderRadius: new BorderRadius.circular(size!.getWidthPx(5))),
          avatar: CircleAvatar(
          ...
          labelStyle: TextStyle(
              fontFamily: 'Exo2',
              color: (_selectedProperty.contains(index))
                  ? backgroundColor
                  : textPrimaryColor),
          elevation: 4.0,
          padding: EdgeInsets.symmetric(
      ...
      child: Column(
        children: <Widget>[
          Row(
            children: <Widget>[
              Container(
                color: _selectedRoom.contains("1RK")
              ...
              Container(
                color: _selectedRoom.contains("1BHK")
                    ? Colors.black.withOpacity(0.3)
                    : backgroundColor,
                child: TextButton(
                  child: Text(
              ...
              Container(
                color: _selectedRoom.contains("2BHK")
                    ? Colors.black.withOpacity(0.3)
                    : backgroundColor,
                child: TextButton(
                  child: Text(
          ...
          Row(
            children: <Widget>[
              Container(
                color: _selectedRoom.contains("3BHK")
                    ? Colors.black.withOpacity(0.3)
                    : backgroundColor,
                child: TextButton(
                  child: Text(
              ...
              Container(
                color: _selectedRoom.contains("4BHK")
                    ? Colors.black.withOpacity(0.3)
                    : backgroundColor,
                child: TextButton(
                  child: Text(
              ...
              Container(
                color: _selectedRoom.contains("4+BHK")
                    ? Colors.black.withOpacity(0.3)
                    : backgroundColor,
                child: TextButton(
                  child: Text(
    ...
    return RangeSlider(
      ...
      onChanged: (value) {
        ...
        setState(() {
          ...
          _upperValueFormatted =
              NumberFormat.compactCurrency(decimalDigits: 0, symbol: '\u20b9')
                  .format(_upperValue * 1000);
          _lowerValueFormatted =
              NumberFormat.compactCurrency(decimalDigits: 0, symbol: '\u20b9')
                  .format(_lowerValue * 1000);
        });
      },
        ...
        child: Container(
          child: Column(
            children: <Widget>[
              ...
              HorizontalList(
                children: <Widget>[
                  for (int i = 0; i < propertyType.length; i++)
                    buildPropertyChip(
                        i, propertyType[i], propertyIcon[i], propertyColor[i])
                ],
              ),
              SizedBox(
                height: size!.hp(2),
              ...
              leftAlignText(
                  text:
                      "Rent Range (INR): $_lowerValueFormatted  to $_upperValueFormatted",
                  leftPadding: size!.getWidthPx(16),
                  textColor: textPrimaryColor,
                  fontSize: size!.getWidthPx(16)),
              SizedBox(
              ...
              Row(
                children: <Widget>[
                  ...
                  Align(
                      alignment: Alignment.centerLeft,
                      child: Text("$_lowerValueString?")),
                  SizedBox(
                    width: size!.wp(70),
                  ),
                  Align(
                      alignment: Alignment.centerRight,
                      child: Text("$_upperValueString?")),
                  SizedBox(
                    width: size!.wp(4),
                  ),
                ],
