...
import 'package:landlord_tenent/LocalBindings.dart';
import 'package:landlord_tenent/services/upload_image.dart';
import 'package:landlord_tenent/ui/page_profile.dart';
import 'package:landlord_tenent/ui/photo_list.dart';
import 'package:landlord_tenent/utils/Constants.dart';
import 'package:landlord_tenent/utils/responsive_screen.dart';
import 'package:landlord_tenent/widgets/utils_widget.dart';
import 'package:flutter/widgets.dart';
import 'package:flutter/material.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
// import 'package:flutter_swiper/flutter_swiper.dart';
import 'package:flutter_swiper_null_safety/flutter_swiper_null_safety.dart';
import 'package:landlord_tenent/services/network_image.dart';
...
class _HouseDetailState extends State<HouseDetail> {
  ...
  void ownerDetail() async {
    ...
    FirebaseFirestore.instance
      ...
      // if (Constants.userRef!['FavouriteHouse']) {
                                  ...
                                  onPressed: () {
                                    ...
                                    if (_fireStatus) {
                                      FirebaseFirestore.instance
                                        ...
                                        var docsSnap = await transaction
                                            .get(snapshot.reference);
                                        await transaction
                                            .update(docsSnap.reference, {
                                          'favourite':
                                              docsSnap['favourite'] + 1,
                                        });
                                      });
                                      FirebaseFirestore.instance
                                          .doc('/User/' + userReference)
                                          .update({
                                        'FavouriteHouse': FieldValue.arrayUnion(
                                            ['/House/' + snapshot.id])
                                      });
                                    } else {
                                      FirebaseFirestore.instance
                              ...
                              Container(
                                ...
                                child: Center(
                                  child: IconButton(
                                    ...
                                    onPressed: () async {
                                      var url = "tel:" +
                                          ownerSnapshot!['mobileNo'].toString();
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Align(
                              ...
                              child: Text(
                                '' +
                                    snapshot['Overview']['preferedType']
                                        .toString(),
                                style: TextStyle(
                                    fontSize: 18,
                                    color: Colors.black.withOpacity(0.6)),
            ...
            child: Container(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Wrap(
                      children: <Widget>[
                        for (var i in snapshot['Facilities']) getFacility(i)
                      ],
                    )
                        ...
                        child: TextButton(
                          onPressed: () {
                            Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (_) =>
                                        MultiImage(snapshot.id, snapshot)));
                          },
                          child: Center(
                              child: Text(
                            "ADD HOUSE IMAGES",
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (_) =>
                            ProfilePage('/User/' + ownerSnapshot!.id, true)));
                ...
                child: Row(
                  children: <Widget>[
                    Container(
                      width: size!.hp(15),
                      color: Colors.grey,
                      child: (ownerSnapshot!.data()! as Map<String, dynamic>)
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          children: <Widget>[
                            ...
                            Align(
                              alignment: Alignment.topLeft,
                              child: Text("${ownerSnapshot!['email']}",
                                  textAlign: TextAlign.left,
                                  style: TextStyle(
                                      color: Colors.grey,
