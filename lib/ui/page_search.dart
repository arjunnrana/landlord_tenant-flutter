...
import 'package:landlord_tenent/ui/page_house_detail.dart';
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Align(
                                ...
                                child:
                                    Text('${docsSnap['builtUpArea']} Sq.ft.')),
                          ),
                        ),
                      ),
                      ResponsiveContainer(
                    ...
                    onPressed: () {
                      ...
                      if (_isPressed[index]) {
                        ...
                        FirebaseFirestore.instance.doc(userReference).update({
                          'FavouriteHouse':
                              FieldValue.arrayUnion(['/House/' + docsSnap.id])
                        });
                      } else {
                        FirebaseFirestore.instance
                            .runTransaction((transaction) async {
                        ...
                        FirebaseFirestore.instance.doc(userReference).update({
                          'FavouriteHouse':
                              FieldValue.arrayRemove(['/House/' + docsSnap.id])
                        });
                      }
