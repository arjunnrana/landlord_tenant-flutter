...
Future<Document> generateDocument(PdfPageFormat format, payment, owner) async {
  final Document pdf =
      Document(title: 'Payment Invoice', author: 'Far From Home');
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      // width: 0.5 * 17 * size,
                      child: detailWidget(true, owner['name'], owner['address'],
                          owner['city'], owner['mobileNo'], owner['email']),
                    ),
                  ],
                ),
                Padding(
                        ...
                        children: <Widget>[
                          Expanded(
                            ...
                            child: Text(
                              ...
                              textAlign: TextAlign.left,
                              style: TextStyle(
                                  color: grey600, fontWeight: FontWeight.bold),
                            ),
                          ),
                          Expanded(
                            flex: 2,
