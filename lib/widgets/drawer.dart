...
import 'package:landlord_tenent/ui/about_developers.dart';
      ...
      children: <Widget>[
        ...
        ListTile(
          ...
          onTap: () {
            Navigator.pop(context);
            Navigator.push(
                context, MaterialPageRoute(builder: (_) => AboutDevelopers()));
            // _uri
          },
        ),
